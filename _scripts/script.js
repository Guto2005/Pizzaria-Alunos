...
$('section#domingo-perfeito').waypoint(function(direcao) {
    if ( direcao == "down") {
        ...
        $('div.folha2').addClass('animate__animated animate__fadeInUp animate__slow');
        ...
        $('div.folha2').removeClass('animate__animated animate__fadeInUp animate__slow')    
        $('div.folha3').removeClass('animate__animated animate__fadeInUp animate__slow')    
...
$('section#plano-principal').waypoint(function(direcao) {
    if (direcao == 'down') {
        ...
        $('div.planos:eq(0)').remoteClass('animate__animated animate__fadeInLeft animate__slower');
        $('div.planos:eq(1)').remoteClass('animate__animated animate__fadeInUp animate__slower');
        $('div.planos:eq(2)').remoteClass('animate__animated animate__fadeInRight animate__slower');
        }
    }, {
        offset: '450px;'
})
